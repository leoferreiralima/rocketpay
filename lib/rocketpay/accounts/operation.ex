defmodule Rocketpay.Accounts.Operation do
  ...
  defp get_account_operation_name(operation), do: "account_#{Atom.to_string(operation)}" |> String.to_atom()
  ...
  defp handle_cast(:error, _balance,_operation), do: {:error, "Invalid balance value!"}
